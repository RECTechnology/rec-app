...
class Brand {
  ...
  static String logoUrl = Assets.logo;
  ...
  static const Color backgroundBanner = Color(0xffFEEED8);
  static const Color backgroundBannerCulture = Color(0xffE6F2EE);
  ...
  static void configLoading() {
    EasyLoading.instance
      ...
      ..indicatorSize = 45.0
      ..radius = 10.0
      ..progressColor = Brand.primaryColor
