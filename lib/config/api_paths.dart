...
class ApiPaths {
  ...
  static ApiPath transactionsPerDay = ApiPath('/user/v1/wallet/day/transactions');
  static ApiPath vendorData = ApiPath('/transaction/v1/vendor');
  static ApiPath payment = ApiPath('/methods/v3/out/rec');
  ...
  static ApiPath currentUserKyc = ApiPath('/user/v3/kycs');
  ...
  static ApiPath acceptTos = ApiPath('/user/v4/campaign/accept_tos');
  ...
  // Recharge
  static ApiPath rechargeRecs = ApiPath('/methods/v3/in/lemonway');
  ...
  // Activities
  static ApiPath activities = ApiPath('/public/v4/activities');
}
